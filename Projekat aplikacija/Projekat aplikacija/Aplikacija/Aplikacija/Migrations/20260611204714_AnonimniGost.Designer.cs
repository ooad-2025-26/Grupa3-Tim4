...
namespace Aplikacija.Migrations
{
    ...
    [Migration("20260611204714_AnonimniGost")]
    partial class AnonimniGost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aplikacija.Models.Placanje", b =>
                {
                    ...
                    b.HasOne("Aplikacija.Models.Rezervacija", "Rezervacija")
                        .WithOne("Placanje")
                        .HasForeignKey("Aplikacija.Models.Placanje", "RezervacijaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
